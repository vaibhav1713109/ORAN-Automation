...
def NT_PTP_1pps(ResultFile, Destination, MPlane, IP_Board):

    print('-'*100)
    print('-'*35 + "Noise Transfer - SyncE to 1pps"+'-'*35)
    ...
    try:
        ...
        calnexSet("app/conformance/test", "Test", 'PTP to 1pps Noise Transfer')
        ...
        calnexSet("cat/measurement/1ppsTEAbsolute/F/PTPNoiseTransfer/-/mask", "MaskName", 'G.8273.2 Class A,B T-BCs Noise Transfer')
        calnexSet("cat/measurement/1ppsTEAbsolute/F/PTPNoiseTransfer/-/visiblewindow", "XMin", 0, "XMax", 0, "YMin", 0, "YMax", 0)
        ...
        notification("Noise Tramsfer - PTP to 1PPS Test Finished!")
