...
def Generate_ORB_prach(test_case_name,duplex_type,eAxID):
    try:
        print("============================================================================================")
        ...
        myProject.FilterPackets(OrsConfiguration.DataDirection.UL, index, FieldTypes.MessageType.U_Plane)
        print(dir(OrsConfiguration.DataDirection))
...
if __name__ == "__main__":
    print(sys.argv)
    if len(sys.argv)>2:
        print(Generate_ORB(sys.argv[1],sys.argv[2]))
    else:
        print('Please run with below format\npython orb_gen.py {test_case_name} {duplex_type}')
