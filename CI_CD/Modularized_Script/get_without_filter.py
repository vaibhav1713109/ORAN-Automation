...
def Result_Declartion():
    ...
    ###############################################################################
        ...
        STARTUP.CREATE_LOGS('Get Without Filter',PDF=pdf) 
...
if __name__ == "__main__":
    ...
    Test_procedure = [f"{'='*100}\nTest case *Get Without Filter* Started!! Status: Running\n{'='*100}",'** Test Coverage **'.center(50),'Static IP Ping',
                'Netopeer Connection','Capability exchange','Create-subscription','Apply Get with out filter', 'Start Time : {}'.format(start_time)]
    notification('\n'.join(Test_procedure))
    Result_Declartion()
