...
## Related Imports
###############################################################################
import M_CTC_ID_012, M_CTC_ID_013
...
def execution():
    Out1 = M_CTC_ID_012.test_m_ctc_id_012()
    Out2 = M_CTC_ID_013.test_m_ctc_id_013()
    ...
    print('\t\t\t Summary')
    print('+'*100)
    Result = [['O-RU Alarm Notification Generation',flag1],['Retrieval of Active Alarm List',flag2]]
