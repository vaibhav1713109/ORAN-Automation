...
class M_CTC_ID_008(vlan_Creation):
    ...
    def test_procedure(self):
        ...
        # for i in range(1,5,1):
            ...
            time.sleep(t)
        notification('All 30 iteration completed!!')
        return True
    ...
    ###############################################################################
    def test_Main(self):
        notification("Test Case M_CTC_ID_008 is under process...")
...
def test_M_ctc_id_008():
    ...
    ###############################################################################
        ...
        notification("Successfully completed Test Case M_CTC_ID_008. Logs captured !!")   
