...
import pytest 
import M_CTC_ID_001, M_CTC_ID_002, M_CTC_ID_003, M_CTC_ID_007, M_CTC_ID_008, M_CTC_ID_009,M_CTC_ID_019, M_CTC_ID_020
import M_CTC_ID_010, M_CTC_ID_011, M_CTC_ID_013, M_CTC_ID_014, M_CTC_ID_015, M_CTC_ID_016, M_CTC_ID_017, M_CTC_ID_018
import M_CTC_ID_021, M_CTC_ID_022, M_CTC_ID_023, M_CTC_ID_026, M_CTC_ID_027, M_CTC_ID_012
# import DHCP_CONF.DHCP_CONF_BASE as DHCP_CONF_BASE
from ncclient.xml_ import to_ele



# def test_M_CTC_ID_001():
#     result_001 = M_CTC_ID_001.test_MAIN_FUNC_001()
#     if result_001 == True:
#         pass
#     else:
...
#     time.sleep(90)
#     result_002 = M_CTC_ID_002.test_MAIN_FUNC_002()
#     if result_002 == True:
#         pass
#     else:
...
#     time.sleep(90)
#     result_003 = M_CTC_ID_003.test_MAIN_FUNC_003()
...
def test_M_CTC_ID_007():
    # time.sleep(80)
    result_007 = M_CTC_ID_007.test_MAIN_FUNC_007()
    if result_007 == True:
        pass
    else:
...
def test_M_CTC_ID_008():
    time.sleep(80)
    result_008 = M_CTC_ID_008.test_MAIN_FUNC_008()
    if result_008 == True:
        pass
    else:
...
def test_M_CTC_ID_009():
    time.sleep(80)
    result_009 = M_CTC_ID_009.test_MAIN_FUNC_009()
    if result_009 == True:
        pass
    else:
...
def test_M_CTC_ID_011():
    time.sleep(80)
    result_011 = M_CTC_ID_011.test_MAIN_FUNC_011()
    if result_011 == True:
        pass
    else:
...
def test_M_CTC_ID_012():
    time.sleep(80)
    result_012 = M_CTC_ID_012.test_MAIN_FUNC_012()
    if result_012 == True:
        pass
    else:
...
def test_M_CTC_ID_013():
    time.sleep(80)
    result_013 = M_CTC_ID_013.test_MAIN_FUNC_013()
    if result_013 == True:
        pass
    else:
...
def test_M_CTC_ID_018():
    time.sleep(80)
    result_018 = M_CTC_ID_018.test_MAIN_FUNC_018()
    if result_018 == True:
        pass
    else:
...
def test_M_CTC_ID_019():
    time.sleep(80)
    result_019 = M_CTC_ID_019.test_MAIN_FUNC_019()
    if result_019 == True:
        pass
    else:
...
def test_M_CTC_ID_020():
    time.sleep(80)
    result_020 = M_CTC_ID_020.test_Main_Func_020()
    if result_020 == True:
        pass
    else:
...
def test_M_CTC_ID_021():
    time.sleep(80)
    result_021 = M_CTC_ID_021.test_Main_Func_021()
    if result_021 == True:
        pass
    else:
...
def test_M_CTC_ID_022():
    time.sleep(80)
    result_022 = M_CTC_ID_022.test_Main_Func_022()
    if result_022 == True:
        pass
    else:
...
def test_M_CTC_ID_023():
    time.sleep(80)
    result_023 = M_CTC_ID_023.test_Main_Func_023()
    if result_023 == True:
        pass
    else:
...
def test_M_CTC_ID_026():
    time.sleep(80)
    result_026 = M_CTC_ID_026.test_Main_Func_026()
    if result_026 == True:
        pass
    else:
...
def test_M_CTC_ID_010():
    time.sleep(80)
    result_010 = M_CTC_ID_010.test_MAIN_FUNC_010()
    if result_010 == True:
        pass
    else:
...
def test_M_CTC_ID_027():
    time.sleep(80)
    result_027 = M_CTC_ID_027.test_Main_Func_027()
    if result_027 == True:
        pass
    else:
...
def test_M_CTC_ID_015():
    time.sleep(80)
    result_015 = M_CTC_ID_015.test_MAIN_FUNC_015()
    if result_015 == True:
        pass
    else:
...
def test_M_CTC_ID_014():
    time.sleep(80)
    result_014 = M_CTC_ID_014.test_MAIN_FUNC_014()
    if result_014 == True:
        pass
    else:
...
def test_M_CTC_ID_016():
    time.sleep(80)
    result_016 = M_CTC_ID_016.test_MAIN_FUNC_016()
    if result_016 == True:
        pass
    else:
...
def test_M_CTC_ID_017():
    time.sleep(80)
    result_017 = M_CTC_ID_017.test_MAIN_FUNC_017()
    if result_017 == True:
        pass
    else:
