    ...
    with manager.connect(host=host, port=port, username=user, hostkey_verify=False, password=password, allow_agent = False , look_for_keys = False) as m:
        ...
        try:
            ...
            try:
                ...
                #     return f'iteration is not completed {e}'
    ...
    try:
        ...
        if m:
            ...
            if res:
                ...
                STARTUP.ACT_RES(f"{'M-Plane Connection Supervision (positive case)' : <50}{'=' : ^20}{'FAIL' : ^20}",PDF= pdf,COL=(255,0,0))
                return res
                ...
                command = "cd {}; cat {} | grep supervision;".format(Config.details['SYSLOG_PATH'],Config.details['syslog_name'])
                ...
                STARTUP.ACT_RES(f"{'M-Plane Connection Supervision (positive case)' : <50}{'=' : ^20}{'SUCCESS' : ^20}",PDF= pdf,COL=(0,255,0))
                return True
