...
from require.DHCP_CONF import ISC_DHCP_SERVER as ISC_DHCP_SERVER
from require.DHCP_CONF import DHCP_CONF_VLAN as DHCP_CONF_VLAN
...
def test_MAIN_FUNC_001():
    ...
    if Res2[0]:
        print('Vlan Creation Complete in local PC...')
    else:
        print('Vlan Creation not Complete in local PC...')
        return 0
